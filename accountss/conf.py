...
from accountss.languages import LANGUAGES
from accountss.timezones import TIMEZONES
...
class AccountssAppConf(AppConf):
    ...
    HOOKSET = "accountss.hooks.AccountDefaultHookSet"
    TIMEZONES = TIMEZONES
    LANGUAGES = LANGUAGES
